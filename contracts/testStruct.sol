...
contract testStruct {
    ...
    function setChairman(address _acc,bool _gen,uint8 _age) public {
        // chairman = Person(_acc,_gen,_age);
        chairman = Person(
            {
                account:_acc,
                gender:_gen,
    ...
    function getFunder(uint id) public view returns(address,uint){
